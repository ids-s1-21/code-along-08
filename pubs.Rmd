...
- `life_exp_female`, `life_exp_male`: the life expectancy at birth of people born in each district, broken down by binary sex (2006--2008) ^[Sex and gender are, of course, more complicated than that, but the ONS only gives "male" and "female" figures; in the UK all birth certificates have one of these two options recorded.]
